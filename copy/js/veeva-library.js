// Veeva JavaScript Library version 27.0.5.1
// http://veeva.com
//
...
com.veeva.clm = {
    ...
    updateCurrentRecord: function(object, values, callback) {
        ...
        // create record
        request = "veeva:saveObjectV2(" + object + "),createRecord(),value(" + JSON.stringify(values) + "),callback(com_veeva_clm_updateCurrentRecord)";
    ...
    // 12,
    // Creates a string as if it was a request for createRecord and returns it
    formatUpdateCurrentRecords:function(objectArray, valueArray) {
        ...
        var fullString = "";
        for (var ndx = 0; ndx < objectArray.length; ndx++) {
            fullString = fullString.concat("veeva:saveObjectV2(" + objectArray[ndx] + "),createRecord(),value(" + JSON.stringify(valueArray[ndx]) + "),callback()" + ";");
        }
